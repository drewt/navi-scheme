...
{
	ck_assert(sexp_bool($(scm_bytevectorp, make_bytevec(1))));
	ck_assert(!sexp_bool($(scm_bytevectorp, make_num(1))));
}
END_TEST
...
{
	sexp_t v = $(scm_make_bytevector, make_num(2));
	bytevector_assert(v, 2);

	v = $(scm_make_bytevector, make_num(2), make_num(3));
	bytevector_assert(v, 2);
...
START_TEST(test_bytevector)
{
	...
	v = $(scm_bytevector, make_num(1), make_num(2));
	bytevector_assert(v, 2);
...
START_TEST(test_bytevector_u8_ref)
{
	...
	ck_assert(sexp_num($(scm_bytevector_u8_ref, v, make_num(0))) == 1);
	ck_assert(sexp_num($(scm_bytevector_u8_ref, v, make_num(1))) == 2);
}
END_TEST
...
START_TEST(test_bytevector_u8_set)
{
	...
	$(scm_bytevector_u8_set, v, make_num(0), make_num(1));
	$(scm_bytevector_u8_set, v, make_num(1), make_num(2));
	bytevector_assert_ref(v, 0, 1);
	bytevector_assert_ref(v, 1, 2);
}
END_TEST
...
{
	sexp_t v0 = $(scm_bytevector, make_num(1), make_num(2));
	sexp_t v1 = $(scm_bytevector, make_num(3), make_num(4));
...
{
	sexp_t v;
	sexp_t o = $(scm_bytevector, make_num(0), make_num(1), make_num(2), make_num(3));
	...
	v = $(scm_bytevector_copy, o, make_num(2));
	bytevector_assert(v, 2);
	bytevector_assert_ref(v, 0, 2);
	bytevector_assert_ref(v, 1, 3);

	v = $(scm_bytevector_copy, o, make_num(1), make_num(3));
	bytevector_assert(v, 2);
	bytevector_assert_ref(v, 0, 1);
	bytevector_assert_ref(v, 1, 2);
}
...
{
	sexp_t v = $(scm_make_bytevector, make_num(4), make_num(4));
	sexp_t o = $(scm_bytevector, make_num(0), make_num(1), make_num(2), make_num(3));

	$(scm_bytevector_copy_to, v, make_num(0), o);
	bytevector_assert_ref(v, 0, 0);
	bytevector_assert_ref(v, 1, 1);
	bytevector_assert_ref(v, 2, 2);
	bytevector_assert_ref(v, 3, 3);
	...
	$(scm_bytevector_copy_to, v, make_num(3), o, make_num(3));
	bytevector_assert_ref(v, 3, 3);

	sexp_bytevec(v)->data[1] = 4;
	$(scm_bytevector_copy_to, v, make_num(1), o, make_num(2), make_num(3));
	bytevector_assert_ref(v, 1, 2);
...
{
	sexp_t v = $(scm_bytevector, make_num(0xCE), make_num(0xBB));
...
{
	sexp_t s = $(scm_string, make_char(0x3BB));
